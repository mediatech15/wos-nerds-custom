(function() {
  ...
  const navMenuData = {
    tools: [
      { name: "Rally Planner", url: "/rallytracker", color: "teal" },
      { name: "Troop Stats", url: "/troop-stats", color: "purple" },
      { name: "Layout Planner", url: "/layout-planner", color: "amber" },
    ],
    external: [
      { name: "Source Code", url: "https://github.com/mediatech15/custom-wos-nerds", color: "zinc" }
    ],
    dataCollection: [
  ...
  function createNavItem(name, url, color, isExternal = false) {
    ...
    const baseClasses = "text-white my-1 py-2 px-4 rounded-lg w-[90%] text-center no-underline block shadow-md transition-all duration-200";
  ...
  function createSectionHeader(title) {
    ...
    h5.className = 'text-center font-semibold text-gray-700 bg-gray-200 py-1 rounded transition-all duration-200';
